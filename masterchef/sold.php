...
{
    case'cake1'://cake1
        $sql = "update user set `cash`=`cash`+100,`exp`=`exp`+40 where `name`='cake1';";
        mysqli_query($conn,$sql) or die("MySQL query error1-1"); 
        $sql2 = "update cakeoven set `status`= 0 where `uid`='1';";
        mysqli_query($conn,$sql2) or die("MySQL query error1-2"); 
        header("Location:cakeoven.php");
        break;
    case'cake2'://cake2
        $sql = "update user set `cash`=`cash`+120,`exp`=`exp`+50 where `name`='cake2';";
        mysqli_query($conn,$sql) or die("MySQL query error2-1"); 
        $sql2 = "update cakeoven set `status`= 0 where `uid`='2';";
        mysqli_query($conn,$sql2) or die("MySQL query error2-2"); 
        header("Location:cakeoven.php");
        break;
    case'cake3'://cake3
        $sql = "update user set `cash`=`cash`+140,`exp`=`exp`+60 where `name`='cake3';";
        mysqli_query($conn,$sql) or die("MySQL query error3-1"); 
        $sql2 = "update cakeoven set `status`= 0 where `uid`='3';";
        mysqli_query($conn,$sql2) or die("MySQL query error3-2"); 
        header("Location:cakeoven.php");
        break;
    case'cake4'://cake4
        $sql = "update user set `cash`=`cash`+160,`exp`=`exp`+70 where `name`='cake4';";
        mysqli_query($conn,$sql) or die("MySQL query error4-1"); 
        $sql2 = "update cakeoven set `status`= 0 where `uid`='4';";
        mysqli_query($conn,$sql2) or die("MySQL query error4-2"); 
        header("Location:cakeoven.php");
        
        break;
    case'bread1'://bread1
        $sql = "update user set `cash`=`cash`+100,`exp`=`exp`+30 where `name`='bread1';";
        ...
        break;
    case'bread2'://bread2
        $sql = "update user set `cash`=`cash`+120,`exp`=`exp`+40 where `name`='bread2';";
        ...
        break;
    case'bread3'://bread3
        $sql = "update user set `cash`=`cash`+140,`exp`=`exp`+50 where `name`='bread3';";
        ...
        break;
    case'bread4'://bread4
        $sql = "update user set `cash`=`cash`+160,`exp`=`exp`+60 where `name`='bread4';";
    ...
    case'cookie1'://cookie1
        $sql = "update user set `cash`=`cash`+100,`exp`=`exp`+20 where `name`='cookie1';";
    ...
    case'cookie2'://cookie2
        $sql = "update user set `cash`=`cash`+120,`exp`=`exp`+30 where `name`='cookie2';";
    ...
    case'cookie3'://cookie3
        $sql = "update user set `cash`=`cash`+140,`exp`=`exp`+40 where `name`='cookie3';";
    ...
    case'cookie4'://cookie4
        $sql = "update user set `cash`=`cash`+160,`exp`=`exp`+50 where `name`='cookie4';";
        ...
        break;
    case'pizza1'://pizza1
        $sql = "update user set `cash`=`cash`+100,`exp`=`exp`+50 where `name`='pizza1';";
        ...
        break;
    case'pizza2'://pizza2
        $sql = "update user set `cash`=`cash`+120,`exp`=`exp`+60 where `name`='pizza2';";
        ...
        break;
    case'pizza3'://pizza3
        $sql = "update user set `cash`=`cash`+140,`exp`=`exp`+70  where `name`='pizza3';";
        ...
        break;
    case'pizza4'://pizza4
        $sql = "update user set `cash`=`cash`+160,`exp`=`exp`+80  where `name`='pizza4';";
