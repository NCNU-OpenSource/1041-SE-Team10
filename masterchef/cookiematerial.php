...
<div id="buy1" class="modal-box">
     <header> <a href="#" class="js-modal-close close">×</a>
        <h3>Buy This Cookie Ingredient?</h3>
    </header>
        <div class="modal-body">
            <p>Do you wish you buy this ingredient packet for $50?</p>
        </div>
        <footer><form method="post" action="buyingredient.php"><button type="submit" class="btn btn-small js-modal-close" name="id" value="cookie1">buy</button></form> </footer>
</div>
<div id="buy2" class="modal-box">
     <header> <a href="#" class="js-modal-close close">×</a>
        ...
        <footer><form method="post" action="buyingredient.php"><button type="submit" class="btn btn-small js-modal-close" name="id" value="cookie2">buy</button></form> </footer>
</div>
<div id="buy3" class="modal-box">
     <header> <a href="#" class="js-modal-close close">×</a>
        ...
        <footer><form method="post" action="buyingredient.php"><button type="submit" class="btn btn-small js-modal-close" name="id" value="cookie3">buy</button></form> </footer>
</div>
