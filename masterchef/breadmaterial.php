...
<?php
	...
	if($rs['exp']>=200){
		echo "<td><img src =\"pics\bread2.png\" width=\"150px\"></td>";
	}
	if($rs['exp']>=400){
		echo "<td><img src =\"pics\bread3.png\" width=\"150px\"></td></tr>";
	}
	if($rs['exp']>=0){
	...
	if($rs['exp']>=600){	
	    echo "<tr><td><img src =\"pics\bread4.png\" style=\"z-index:10\" width=\"150px\"></td>";
    }
    if($rs['exp']>=600){
